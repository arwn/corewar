...
#define ERR_UNEXPECTED_ARG                                                     \
  ERR_TEMPLATE("Unexpected argument to command \"%s\": ")
#define ERR_BAD_NUM_OF_ARGS                                                    \
  ERR_FIRST_BIT "Bad number of arguments to command \"%s\""

// # define WARNING_UNKNOWN_LABEL WARNING_MOD"WARNING"NC" LINE
// %u:%u\nUnrecognized label "ERR_SECOND_BIT # define ERR_UNKNOWN_LABEL
// ERR_TEMPLATE("Unrecognized label ")
#define ERR_UNKNOWN_LABEL ERR_FIRST_BIT "Unrecognized label \"%s\""
#define WARNING_PROG_TOO_BIG                                                   \
  WARNING_MOD "WARNING" NC " LINE %u\nProgram too large.  Truncating"

// disassembler errors
#define WARNING_PROG_TOO_BIG_DISASM                                            \
  WARNING_MOD "WARNING" NC " Binary too large.  Truncating"
#define WARNING_FILE_TRUNC                                                     \
  WARNING_MOD "WARNING" NC " File appears to be truncated"
